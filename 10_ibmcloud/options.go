...
func cliParse() *options {
	...
	flag.StringVar(&opt.Cloud, "cloud", opt.Cloud, "cloud where to build the letchat service. Available options are: 'aws' and 'ibm'")
	...
	flag.StringVar(&opt.PubKeyFile, "pub", opt.PubKeyFile, "public key file to create the Key Pair")
	flag.StringVar(&opt.PrivKeyFile, "priv", opt.PrivKeyFile, "private key file to connect to the new instance")
